    ...
    public class LlmClientFactory : ILlmClientFactory
    {
            ...
            ILoggerFactory loggerFactory)
        {
            ...
            _logger.LogInformation(
                "LlmClientFactory initialized with model tiers: Fast={FastModel}, Standard={StandardModel}, Premium={PremiumModel}",
        ...
        public ILlmService CreateClient(LlmModelTier tier)
        {
            ...
            {
                var errorMessage =
                    $"Model name not configured for tier: {tier}. Please check LlmModels:{tier}:ModelName in appsettings.json";
