    ...
    public class OpenAiEmbeddingGenerationService : IEmbeddingGenerationService
    {
        ...
        private async Task WaitForRateLimit(List<string> batch)
        {
            ...
            try
            {
                ...
                if (_tokensUsedInLastMinute + estimatedTokens > _settings.TpmLimit ||
                    _requestsInLastMinute > _settings.RpmLimit)
                {
        ...
        private class EmbeddingResponse
        {
            ...
            [JsonPropertyName("usage")] public UsageInfo Usage { get; set; } = new();
        }
