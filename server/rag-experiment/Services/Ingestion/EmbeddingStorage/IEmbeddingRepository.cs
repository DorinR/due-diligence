...
namespace rag_experiment.Services.Ingestion.VectorStorage
{
    ...
    public interface IEmbeddingRepository
    {
        ...
        void AddEmbedding(string text, float[] embeddingData, string documentId, int? userId, int? conversationId,
            string documentTitle, EmbeddingOwner owner, int chunkIndex, byte[] chunkHash,
        ...
        void UpdateEmbedding(int id, string newText, float[] newEmbeddingData, string? documentId = null,
        ...
        List<(string Text, string DocumentId, string DocumentTitle, float Similarity)>
        ...
        Task<List<(string Text, string DocumentId, string DocumentTitle, float Similarity)>> FindSimilarEmbeddingsAsync(
        ...
        Task UpsertEmbeddingsAsync(IEnumerable<EmbeddingUpsertItem> items,
        ...
        /// <param name="cancellationToken">Cancellation token.</param>
        /// <returns>Task that completes when the batch upsert finishes.</returns>
        Task UpsertDocumentEmbeddingsAsync(IEnumerable<EmbeddingUpsertItem> items,
            CancellationToken cancellationToken = default);
    }
}