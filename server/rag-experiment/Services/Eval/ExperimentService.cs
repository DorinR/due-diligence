...
namespace rag_experiment.Services
{
    public class ExperimentService : IExperimentService
    {
            ...
            Dictionary<string, bool> textProcessingOptions)
        {
            ...
            {
                experiment.StopwordRemoval = textProcessingOptions.GetValueOrDefault("StopwordRemoval",
                    _ragSettings.TextProcessing.StopwordRemoval);
                experiment.Stemming =
                    textProcessingOptions.GetValueOrDefault("Stemming", _ragSettings.TextProcessing.Stemming);
                experiment.Lemmatization =
                    textProcessingOptions.GetValueOrDefault("Lemmatization", _ragSettings.TextProcessing.Lemmatization);
                experiment.QueryExpansion =
                    textProcessingOptions.GetValueOrDefault("QueryExpansion",
                        _ragSettings.TextProcessing.QueryExpansion);
