...
namespace rag_experiment.Services
{
    public class MarkdownTableService
    {
        ...
        private string GenerateMarkdownRow(ExperimentResult experiment)
        {
            ...
            return
                $"| {escapedName} | {formattedDate} | {experiment.TopK} | {precision} | {recall} | {f1Score} | {experiment.ChunkSize} | {experiment.ChunkOverlap} | {escapedModel} | {textProcessing} | {escapedDescription} |";
        }
