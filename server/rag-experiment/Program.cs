...
builder.Services.AddScoped<ITextExtractor, MultiFormatTextExtractor>();
...
builder.Services
    .AddScoped<rag_experiment.Services.Query.IQueryIntentClassifier,
        rag_experiment.Services.Query.QueryIntentClassifier>();
builder.Services
    .AddScoped<rag_experiment.Services.Query.IAdaptiveRetrievalStrategy,
        rag_experiment.Services.Query.AdaptiveRetrievalStrategy>();
